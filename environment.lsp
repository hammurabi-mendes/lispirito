(define nil? (lambda (param) (eq? param '())))
(define map (lambda (func lst)    (cond        ((nil? lst) '())        (#t (cons (func (car lst)) (map func (cdr lst))))    )))
(define foldl (lambda (binfunc acc lst)    (cond        ((eq? lst '()) acc)        (#t (foldl binfunc (binfunc (car lst) acc) (cdr lst)))    )))
(define foldr (lambda (binfunc acc lst)    (cond        ((eq? lst '()) acc)        (#t (binfunc (car lst) (foldr binfunc acc (cdr lst))))    )))
(define filter (lambda (pred lst)    (cond        ((eq? lst '()) '())        ((pred (car lst)) (cons (car lst) (filter pred (cdr lst))))        (#t (filter pred (cdr lst)))    )))
...
(define flatten (lambda (lst)    (cond        ((eq? lst '()) '())        ((atom? (car lst)) (cons (car lst) (flatten (cdr lst))))        (#t (append (flatten (car lst)) (flatten (cdr lst))))    )))
